                ...
                <table id="example2" class="table">
                    ...
                    <tr>
                        <table style="width: 100%" class="insideTable">
                            ...
                            {{-- CHAPTER 2 --}}
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">CHAPTER 2: REVIEW OF
                            ...
                            {{-- CH2Q1 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Sufficient overview of relevant research
                                    in particular area is provided</td>
                                <td class="insideTD text-center"><input name="CH2Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q1" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH2Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q2" type="radio" required></td>
                            </tr>
                            {{-- CH2Q3 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Relationship of the problem to previous
                                    research/literature is made clear</td>
                                <td class="insideTD text-center"><input name="CH2Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q3" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH2Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q4" type="radio" required></td>
                            </tr>
                            {{-- CH2Q5 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Present the synthesis thoroughly</td>
                                <td class="insideTD text-center"><input name="CH2Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q5" type="radio" required></td>
                            </tr>
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">Theoretical/Conceptual
                                    Framework</td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH2Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q6" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Research questions support the main
                                    problem</td>
                                <td class="insideTD text-center"><input name="CH2Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q7" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Hypothesis is clearly and properly
                                    stated with empirical referents (Qualitative Research has no hypothesis, only assumption
                                    if necessary)</td>
                                <td class="insideTD text-center"><input name="CH2Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q8" type="radio" required></td>
                            </tr>
                            ...
                            {{-- CH2Q9 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The independent and dependent variables
                                    are correctly identified (Variables in Qualitative research are called phenomena and it
                                    can only have one or two independent variables)</td>
                                <td class="insideTD text-center"><input name="CH2Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH2Q9" type="radio" required></td>
                            </tr>
                            {{-- CHAPTER 3 --}}
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">CHAPTER 3: METHODOLOGY
                                </td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">Research Design</td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            {{-- CH3Q1 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Described clearly and appropriate to the
                                    problem</td>
                                <td class="insideTD text-center"><input name="CH3Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q1" type="radio" required></td>
                            </tr>
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">Research Locale</td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH3Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q2" type="radio" required></td>
                            </tr>
                            ...
                            {{-- CH3Q3 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• It is appropriate and clearly described
                                </td>
                                <td class="insideTD text-center"><input name="CH3Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q3" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH3Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q4" type="radio" required></td>
                            </tr>
                            ...
                            {{-- CH3Q5 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Research Instrument is appropriate and
                                    clearly described</td>
                                <td class="insideTD text-center"><input name="CH3Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q5" type="radio" required></td>
                            </tr>
                            {{-- CH3Q6 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Validity and Reliability of instruments
                                    are properly established</td>
                                <td class="insideTD text-center"><input name="CH3Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q6" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH3Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q7" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Procedure is appropriate to research
                                    design</td>
                                <td class="insideTD text-center"><input name="CH3Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q8" type="radio" required></td>
                            </tr>
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">Statistical Treatment
                                </td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Appropriate, clear and objectively
                                    ...
                                    triangulation)</td>
                                <td class="insideTD text-center"><input name="CH3Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q9" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH3Q10" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q10" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q10" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q10" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• All relevant aspects of ethical
                                    ...
                                    research </td>
                                <td class="insideTD text-center"><input name="CH3Q11" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q11" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q11" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH3Q11" type="radio" required></td>
                            </tr>
                            {{-- CHAPTER 4 --}}
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">CHAPTER 4: RESULTS AND
                                    DISCUSSION
                                </td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH4Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q1" type="radio" required></td>
                            </tr>
                            {{-- CH4Q2 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Procedures are described in great detail
                                </td>
                                <td class="insideTD text-center"><input name="CH4Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q2" type="radio" required></td>
                            </tr>
                            {{-- CH4Q3 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The selected methods for data analysis
                                    are highly suitable</td>
                                <td class="insideTD text-center"><input name="CH4Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q3" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH4Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q4" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q4" type="radio" required></td>
                            </tr>
                            {{-- CH4Q5 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Procedures are described in details</td>
                                <td class="insideTD text-center"><input name="CH4Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q5" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q5" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The selected methods for data analysis
                                    are good</td>
                                <td class="insideTD text-center"><input name="CH4Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q6" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q6" type="radio" required></td>
                            </tr>
                            {{-- CH4Q7 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The research methodology is satisfactory
                                    for achieving the study objectives</td>
                                <td class="insideTD text-center"><input name="CH4Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q7" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q7" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• Procedures are described in general
                                    terms</td>
                                <td class="insideTD text-center"><input name="CH4Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q8" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q8" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The selected methods for data analysis
                                    are suitable</td>
                                <td class="insideTD text-center"><input name="CH4Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q9" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH4Q9" type="radio" required></td>
                            </tr>
                            ...
                            {{-- CH5Q1 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The expected key findings of the study
                                    are very clearly stated</td>
                                <td class="insideTD text-center"><input name="CH5Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q1" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q1" type="radio" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="insideTD text-center"><input name="CH5Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q2" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q2" type="radio" required></td>
                            </tr>
                            <tr>
                                <td class="insideTD" style="font-weight: bold; padding-left: 10px">Recommendations</td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                                <td class="insideTD"></td>
                            ...
                            {{-- CH5Q3 --}}
                            <tr>
                                <td class="insideTD" style="padding-left: 10px">• The recommendations are clearly stated
                                </td>
                                <td class="insideTD text-center"><input name="CH5Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q3" type="radio" required></td>
                                <td class="insideTD text-center"><input name="CH5Q3" type="radio" required></td>
                            </tr>
                        ...
                        <div class="row p-3">
                            <p>
                                ...
                                <span style="margin-left: 70px">First Defense</span><span style="margin-left: 105px">90 - 100</span> <br>
                                <span style="margin-left: 70px">Re - Appearance</span><span style="margin-left: 85px">85 - 89</span> <br>
                                <span style="margin-left: 70px">Re - Defense</span><span style="margin-left: 110px">84 - below</span> <br><br>
