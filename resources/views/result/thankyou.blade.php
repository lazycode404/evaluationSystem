...
<body>
    ...
    <br>
    <div class="main-content text-center">
        <a href="{{ url('home/' . $courses->Coursename . '/' . $section->Sectionname . '/' . $member->groupName . '/title_evalutaion/result') }}" class="btn btn-primary" style="color: white">VIEW EVALUATION RESULT</a>
